<template>
  <nav class="bg-gradient-to-r from-slate-900 via-blue-gray-800 to-slate-800 shadow-lg px-4 sm:px-6 lg:px-8 py-3">
      ...
      <div class="hidden sm:flex items-center gap-4">
        <template v-if="isLoggedIn">
          <router-link
            ...
            :class="$route.path === '/' ? 'bg-gray-700 text-white shadow-sm' : ''"
          >
            Homepage
          </router-link>
          <router-link
            to="/add"
            class="px-3 py-1 rounded-lg font-medium text-sm transition text-gray-300 hover:text-white hover:bg-gray-700"
            :class="$route.path === '/add' ? 'bg-gray-700 text-white shadow-sm' : ''"
          >
            Add Movie
          </router-link>
          <router-link
            to="/favourites"
            class="px-3 py-1 rounded-lg font-medium text-sm transition text-gray-300 hover:text-white hover:bg-gray-700"
            :class="$route.path === '/favourites' ? 'bg-gray-700 text-white shadow-sm' : ''"
          >
            My Favourites
          </router-link>
